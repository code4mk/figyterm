...
pub fn run() {
    ...
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::claude::claude_probe,
            commands::claude::claude_transcript_head,
            commands::claude::claude_past_conversations,
            ...
            commands::git::git_conflict_marks,
            commands::git::git_resolve_with,
            commands::git::git_mark_resolved,
            commands::git::git_merge_abort,
            commands::git::git_branches,
            commands::git::git_switch,
            commands::git::git_stash_list,
            commands::git::git_stash_push,
            commands::git::git_stash_restore,
