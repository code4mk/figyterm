// @ts-nocheck
const postProcessDockerPs: Figy.Generator["postProcess"] = (out) => {
  return out.split("\n").map((i) => {
    try {
...
const sharedPostProcess: Figy.Generator["postProcess"] = (out) => {
  return out
    .split("\n")
...
const dockerGenerators: Record<string, Figy.Generator> = {
...
const sharedCommands: Record<string, Figy.Subcommand> = {
  build: {
    name: "build",
