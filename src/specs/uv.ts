...
// ////////////////////////////////////////////////////////////////// Options //////////////////////////////////////////////////////////////////
const indexOptions: Figy.Option[] = [
  {
    name: "--index",
    description:
...
const cacheOptions: Figy.Option[] = [
  {
    name: "--no-cache",
    description:
...
const resolverOptions: Figy.Option[] = [
  {
    name: "-U",
    description:
...
const installerOptions: Figy.Option[] = [
  {
    name: "--reinstall",
    description:
...
const buildOptions: Figy.Option[] = [
  {
    name: "-C",
    description:
...
const pythonOptions: Figy.Option[] = [
  {
    name: ["-p", "--python"],
    description:
...
const initCacheOptions: Figy.Option[] = [
  {
    name: "-n",
    description:
      "Avoid reading from or writing to the cache, instead using a temporary directory for the duration of the operation",
...
//    remove
const removeOptions: Figy.Option[] = [
  {
    name: "--dev",
...
const lockInstallerOptions: Figy.Option[] = [
  {
    name: "--link-mode",
    description:
      "The method to use when installing packages from the global cache",
...
//  export
const exportOptions: Figy.Option[] = [
  {
    name: "--format",
...
const toolSubcommands: Figy.Subcommand[] = [
  {
    name: "run",
...
const pythonSubcommands: Figy.Subcommand[] = [
  {
    name: "list",
...
// pip
const pipSubcommands: Figy.Subcommand[] = [
  {
    name: "compile",
    description:
...
// build
const buildCommandOptions: Figy.Option[] = [
  {
    name: "--package",
...
// publish
const publishOptions: Figy.Option[] = [
  {
    name: "--publish-url",
...
// cache
const cacheSubcommands: Figy.Subcommand[] = [
  {
    name: "clean",
...
// self
const selfSubcommands: Figy.Subcommand[] = [
  {
    name: "update",
...
const subcommands: Figy.Subcommand[] = [
  {
    name: "run",
...
const globalOptions: Figy.Option[] = [
  {
    name: ["-q", "--quiet"],
