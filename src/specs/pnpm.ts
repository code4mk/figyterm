...
const searchBranches: Figy.Generator = {
  ...
  postProcess: function (out) {
    ...
    return output.split("\n").map((elm) => {
      ...
      return {
        name,
        description: "Branch",
        icon: "figy://icon?type=git",
      };
    });
  },
};

const generatorInstalledPackages: Figy.Generator = {
  script: ["pnpm", "ls"],
  postProcess: function (out) {
    /**
     * out
...
const FILTER_OPTION: Figy.Option = {
  name: "--filter",
  args: {
    template: "filepaths",
...
const INSTALL_BASE_OPTIONS: Figy.Option[] = [
  {
    name: "--offline",
    description:
...
const INSTALL_OPTIONS: Figy.Option[] = [
  {
    name: ["-P", "--save-prod"],
...
const INSTALL_PACKAGE_OPTIONS: Figy.Option[] = [
  {
    name: ["-P", "--save-prod"],
...
// SUBCOMMANDS
const SUBCOMMANDS_MANAGE_DEPENDENCIES: Figy.Subcommand[] = [
  {
    name: "add",
...
const SUBCOMMANDS_RUN_SCRIPTS: Figy.Subcommand[] = [
  {
    name: ["run", "run-script"],
...
const SUBCOMMANDS_REVIEW_DEPS: Figy.Subcommand[] = [
  {
    name: "audit",
...
const SUBCOMMANDS_MISC: Figy.Subcommand[] = [
  {
    name: "publish",
...
// common options
const COMMON_OPTIONS: Figy.Option[] = [
  {
    name: ["-C", "--dir"],
    args: {
      name: "path",
...
const completionSpec: Figy.Spec = {
  ...
  generateSpec: async (tokens, executeShellCommand) => {
    const { script, postProcess } = dependenciesGenerator as Figy.Generator & {
      script: string[];
    };
